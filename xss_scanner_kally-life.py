# import admin kally life
# if you're a script kids, please go back
#!/usr/bin/env python
import mechanize
import sys
import httplib
...
xss_scanner - Cerca XSS in sito web
Author: kally-life (Cyber-Army)
Usa: xss_scanner_kally_-life.py site.com (Non usare www.site.com O http://www.site.com)
Scrivi: python xss_scanner_kally-life.py -u site.com -e
Verbose logging: python xss_scanner_kally-life.py -u site.com -v
Cookies: python xss_scanner_kally-life.py -u site.complex -c name=val name=val

Description: xss_scanner_kally-life is a python tool for finding Cross Site Scripting
...
After that, it starts scanning each and every input on each and every
 page that it found while its traversal.
""" + color.END
